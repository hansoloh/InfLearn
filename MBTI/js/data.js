const qnaList = [
  {
    ...
    a: [
      ...
      { answer: 'b. 친구 있지, 절대 이성으로만 안 보일뿐', type: ['mouse', 3, 6, 5, 10, 8] },
  ...
  },
  {
    ...
    a: [
      { answer: 'a. 바로 먼저 연락한다.', type: ['mouse', 3, 2, 8] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: 'c. 완벽한 분위기, 완벽한 타이밍에서 고백한다.', type: ['mouse', 6, 5, 4] }
    ]
  },
  {
    ...
    a: [
      ...
      { answer: 'c. 센스있는 "우리 내일은 연인으로 만날까요" ', type: ['mouse', 3, 6, 5 ] },
    ]
  },
  {
    ...
    a: [
      ...
      { answer: 'b. 요즘 시대가 어느 때인데, 가벼운 뽀뽀까지 가능이야', type: ['mouse', 3, 6, 11]},
...

  {
    ...
    a: [
      ...
      { answer: 'b. 맛있는 밥이나 사줄까? 아니면 꽃이라도?', type: ['mouse', 3, 6, 10 ] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: 'c. "오 대박 오늘 머리도 바꾸고 옷도 새로 샀네?"라고 하며 단번에 눈치챈다', type: ['mouse', 3, 6, 5, 10, 8 ] },
    ]
  },
  {
  ...
  },
  {
    ...
    a: [
      { answer: 'a. 뭐.. 언젠가 연락 오겠지. 내가 할 일 하며 기다린다', type: [7, 'mouse', 5, 9 ] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: 'b. 아 그래?? 나 할 것들 좀만 마무리하고 나갈게', type: ['mouse', 2, 6, 5 ] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: 'b. 보고싶을 때 보고, 데이트도 많이 하고 꽁냥꽁냥하는 연애가 좋아.', type: [7, 'mouse', 3, 6, 10] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: 'b. "야! 너 화내지마. 너 잘못이지. 내가 뭘 잘못했는데?" 소리지르며 끝까지 불같이 화낸다.', type: ['mouse', 2, 5, 10, 8] },
